...
batch_size = 100
FILE_fb = './save/MNIST/fb_novae_epoch_50.pth'
# device
...
with torch.no_grad():
    ...
    for idx, (images, labels) in enumerate(test_loader, start=1):
        ...
        ker_pred = hash_and_get_filter(LR_images, filter_bank, training=False)
        ...
        for idx in range(6):
            ...
            img1 = images[idx,0,:,:].numpy()
            img2 = LR_images[idx,0,:,:].numpy()
            img3 = filtered[idx,0,:,:].numpy()
